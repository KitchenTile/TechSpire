...
var mockShow = new Show { Id = 1, Name = "Mock Show", StartTime = 1900, EndTime = 2000, ChannelId = [1, 2]};
var mockShow2 = new Show { Id = 2, Name = "Mock Show2", StartTime = 1600, EndTime = 1900, ChannelId = [1]};
var mockShow3 = new Show { Id = 3, Name = "Mock Show3", StartTime = 2000, EndTime = 2100, ChannelId = [1, 2]};
